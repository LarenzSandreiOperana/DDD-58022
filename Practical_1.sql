...
CREATE TABLE Computer (
    ...
    ProcessorType VARCHAR(24) NOT NULL,
    ProcessorSpeed INT NOT NULL,
    MainMemory VARCHAR(15) NOT NULL,
    DiskSize VARCHAR(15) NOT NULL
);

INSERT INTO Computer (ID, Make, Model, ProcessorType, ProcessorSpeed, MainMemory, DiskSize) VALUES
...
ALTER TABLE Computer ADD Graphics VARCHAR(40) NOT NULL DEFAULT 'Integrated Intel HD Graphics 4600';
